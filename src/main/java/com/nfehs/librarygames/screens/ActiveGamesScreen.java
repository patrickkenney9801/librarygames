...
/**
 * This class handles the user browsing their active games It also directs players to creating new
 * games and spectating games
 *
...
public class ActiveGamesScreen extends Screen {
  ...
  public ActiveGamesScreen() {
    ...
    createGame.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 75, (int) Game.screenSize.getHeight() / 10, 150, 30);
    ...
    spectatorGames.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 75,
        (int) Game.screenSize.getHeight() / 10 + 50,
        150,
        30);
    spectatorGames.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
    ...
    refresh.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 75,
        (int) Game.screenSize.getHeight() / 10 + 160,
        150,
        30);
  ...
  public void loadActiveGames() {
    ...
    finished.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 500,
        (int) Game.screenSize.getHeight() / 10 + 200,
        300,
        30);
    ...
    finishedGamesTab.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 500,
        (int) Game.screenSize.getHeight() / 10 + 230,
        300,
    ...
    for (int i = 0; i < finishedGames.length; i++) {
      ...
      finishedGames[i].addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent e) {
              System.out.println(
                  "An finished game clicked: " + ((JButton) e.getSource()).getText());

              // get the element number of button to find game key
              int elemNumber = -1;
              for (int i = 0; i < finishedGames.length; i++)
                if (finishedGames[i].equals(e.getSource())) elemNumber = i;
              if (elemNumber == -1) return;
    ...
    for (int i = 0; i < activeGamesUserTurn.length; i++) {
      ...
      activeGamesUserTurn[i].addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent e) {
              ...
              int elemNumber = -1;
              for (int i = 0; i < activeGamesUserTurn.length; i++)
                if (activeGamesUserTurn[i].equals(e.getSource())) elemNumber = i;
              if (elemNumber == -1) return;
    ...
    opponentTurn.setBounds(
        (int) Game.screenSize.getWidth() / 2 + 200,
        (int) Game.screenSize.getHeight() / 10 + 200,
        300,
        30);
    ...
    for (int i = 0; i < activeGames.length; i++) {
      ...
      activeGames[i].addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent e) {
              System.out.println("An active game clicked: " + ((JButton) e.getSource()).getText());
              ...
              int elemNumber = -1;
              for (int i = 0; i < activeGames.length; i++)
                if (activeGames[i].equals(e.getSource())) elemNumber = i;
              if (elemNumber == -1) return;
