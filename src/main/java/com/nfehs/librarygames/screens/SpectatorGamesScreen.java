...
/**
 * This class handles the user browsing active games that are not their own It also directs players
 * back to ActiveGamesScreen
 *
...
public class SpectatorGamesScreen extends Screen {
  ...
  public SpectatorGamesScreen() {
    ...
    refresh.setBounds(
        ...
        (int) Game.screenSize.getHeight() / 5 - 60,
        150,
        30);
  ...
  public void loadSpectatorGames() {
    ...
    spectate.setBounds(
        ...
        (int) Game.screenSize.getHeight() / 5 - 30,
        300,
        30);
    ...
    spectatorGamesTab.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 150,
        (int) Game.screenSize.getHeight() / 5,
        300,
    ...
    for (int i = 0; i < spectatorGames.length; i++) {
      ...
      spectatorGames[i].addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent e) {
              System.out.println(
              ...
              int elemNumber = -1;
              for (int i = 0; i < spectatorGames.length; i++)
                if (spectatorGames[i].equals(e.getSource())) elemNumber = i;
