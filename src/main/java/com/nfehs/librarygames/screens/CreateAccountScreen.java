...
public class CreateAccountScreen extends Screen {
  ...
  public CreateAccountScreen() {
    ...
    user.setBounds(
        ...
        (int) Game.screenSize.getHeight() / 2 - 250,
        150,
        30);
    ...
    username.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 75,
        (int) Game.screenSize.getHeight() / 2 - 220,
        150,
        30);
    ...
    em.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 75,
        (int) Game.screenSize.getHeight() / 2 - 190,
        150,
        30);
    ...
    email.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 75,
        (int) Game.screenSize.getHeight() / 2 - 160,
        150,
        30);
    ...
    pass.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 75,
        (int) Game.screenSize.getHeight() / 2 - 130,
        150,
        30);
    ...
    password.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 75,
        (int) Game.screenSize.getHeight() / 2 - 100,
        150,
        30);
    ...
    passConfirm.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 75,
        (int) Game.screenSize.getHeight() / 2 - 70,
        150,
        30);

    passwordConfirm = new JPasswordField();
    Game.mainWindow.add(passwordConfirm);
    passwordConfirm.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 75,
        (int) Game.screenSize.getHeight() / 2 - 40,
        150,
        30);
    passwordConfirm.addKeyListener(
        new KeyListener() {
          public void keyPressed(KeyEvent e) {}
    ...
    createAccount.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 75,
        (int) Game.screenSize.getHeight() / 2 + 10,
        150,
        30);
    ...
    back.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 75,
        (int) Game.screenSize.getHeight() / 2 + 60,
        150,
        30);
  ...
  private void createAccount() {
    Game.createAccount(
        username.getText(), email.getText(), password.getPassword(), passwordConfirm.getPassword());
  }
