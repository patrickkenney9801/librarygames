...
public class CreateOfflineGameScreen extends Screen {
  ...
  public CreateOfflineGameScreen() {
    ...
    gameChoices.setBounds(
        ...
        (int) Game.screenSize.getHeight() / 2 - 300,
        150,
        30);
    ...
    p2.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 75,
        (int) Game.screenSize.getHeight() / 2 - 170,
        150,
        30);
    ...
    player2.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 75,
        (int) Game.screenSize.getHeight() / 2 - 140,
        150,
        30);
    player2.addKeyListener(
        new KeyListener() {
          public void keyPressed(KeyEvent e) {}
    ...
    createOfflineGame.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 75,
        (int) Game.screenSize.getHeight() / 2 - 50,
        150,
        30);
    createOfflineGame.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            ...
            if (player1Username.length() < 1) player1Username = "Player 1";
            if (player2Username.length() < 1) player2Username = "Player 2";
    ...
    back.setBounds(
        (int) Game.screenSize.getWidth() / 2 - 75, (int) Game.screenSize.getHeight() / 2, 150, 30);
